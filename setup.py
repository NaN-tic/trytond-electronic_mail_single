...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='Tryton module that allows to send a single email grouping '
        'several records of the same addressee, and creating a single '
        'attachment with all documents of the same type.',
